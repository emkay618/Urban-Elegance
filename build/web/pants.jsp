...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="container">
                <div class="card-header my-3">All Pants</div>
                <c:if test="${empty pants}">
                    <p>No pants available.</p>
                </c:if>
                <c:forEach var="pants" items="${pants}">
                    <div class="col-md-5 my-3">
                        <div class="card w-800">
                            <div class="card-body">
                                <img src="${pants.imageUrl}" alt="${pants.name}">
                                <h2>${pants.name}</h2>
                                <p>Price: $${pants.price}</p>
                                <div class="mt-3 d-flex justify-content-between">
                                    <a class="btn btn-dark" href="add-to-cart?id=${pants.productId}">Add to Cart</a> 
                                    <a class="btn btn-primary" href="buy-now-servlet?id=${pants.productId}">Buy Now</a>
                                </div>
                            </div>
                        </div>
                    </div>

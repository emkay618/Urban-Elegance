...
public class ProductLevelServlet extends HttpServlet {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(ProductLevelServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Set products as attribute in request
            request.setAttribute("products", products);
            // Forward request to productLevel.jsp for displaying products
            request.getRequestDispatcher("productLevel.jsp").forward(request, response);
            ...
            Logger.getLogger(ProductLevelServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="container">
                <div class="card-header my-3">All Hats</div>
                <c:if test="${empty hats}">
                    <p>No hats available.</p>
                </c:if>
                <c:forEach var="hats" items="${hats}">
                    <div class="col-md-5 my-3">
                        <div class="card w-800">
                            <div class="card-body">
                                <img src="${hats.imageUrl}" alt="${hats.name}">
                                <h2>${hats.name}</h2>
                                <p>Price: $${hats.price}</p>
                                <div class="mt-3 d-flex justify-content-between">
                                    <a class="btn btn-dark" href="add-to-cart?id=${hats.productId}">Add to Cart</a> 
                                    <a class="btn btn-primary" href="buy-now-servlet?id=${hats.productId}">Buy Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
